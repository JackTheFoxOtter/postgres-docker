...
# Database arguments
parser.add_argument('-ds', '--database_connection_sync', type=str, help="Sync database connection string, without database name")
parser.add_argument('-da', '--database_connection_async', type=str, help="Async database connection string, without database name")
# Quart arguments
...
# Global constants
ENVIRONMENT = args.environment or os.getenv('ENVIRONMENT') or 'Production'
